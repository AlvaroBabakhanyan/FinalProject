...
public class HomePage {
    ...
    private By affordabilityCalculatorLink = By.linkText(HomePageConstants.AFFORDABILITY_CALCULATOR);
    ...
    public void inputInSearchBar(String searchText) {
        ElementPresenceChecker.middleWaitUntilClickable(driver, searchBar);
    ...
    public HomesForSalePage inputSearchKeywordAndClickFirstSearchSuggestion(String keyword) {
        ...
        ElementPresenceChecker.shortWaitUntilClickable(driver, firstSuggestion);
    ...
    public AffordabilityCalculatorPage clickBuy_affordabilityCalculator() {
        ...
        WebElement subMenu = driver.findElement(affordabilityCalculatorLink);
    ...
    public String getUnsuccessfulSearchMessage() {
        ElementPresenceChecker.longWaitUntilVisible(driver, unsuccessfulSearchMessage);
